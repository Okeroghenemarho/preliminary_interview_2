...
(`name_id`, `firstname`,    `lastname`,    `email`,                 `phone`,      `pollingunit_uniqueid`) VALUES
...
"""
# contains all  database from bincom_test.sql
# all null values in the sql file were changed to NONE because that is what I can work with as a beginner




# Create another data.py
AGENT_TABLE_HEADER = ('name_id', 'firstname', 'lastname', 'email', 'phone', 'pollingunit_uniqueid')
AGENT_TABLE_ROWS = [(1, 'Christian', 'Emenike', 'christian@bincom.net', '08034699500', 1),
                    (2, 'Ngozi', 'Emenike', 'biggysmalls@home.net', '08089003444', 2),
                    (3, 'Chinyere', 'Emenike', 'chinyere@emenike.net', '07034532310', 1),
                    (4, 'Chimezie', 'Emenike', 'chimezie@emenike.net', '07034532322', 2)]


ANNOUNCED_LGA_RESULTS_TABLE_HEADER = (
'result_id', 'lga_name', 'party_abbreviation', 'party_score', 'entered_by_user', 'date_entered', 'user_ip_address')

ANNOUNCED_LGA_RESULTS_TABLE_ROWS = [
...
ANNOUNCED_STATE_RESULTS_TABLE_HEADER = (
    'result_id',
    'ward_name',
    'party_abbreviation',
    'party_score',
...
ANNOUNCED_STATE_RESULTS_TABLE_ROWS = []

ANNOUNCED_WARD_RESULTS_TABLE_HEADER = (
    'result_id',
    'ward_name',
    'party_abbreviation',
    'party_score',
...
ANNOUNCED_WARD_RESULTS_TABLE_ROWS = []
...
PARTY_TABLE_HEADER = ('id', 'partyid', 'partyname')
...
POLLING_UNIT_TABLE_HEADER = (
'uniqueid', 'polling_unit_id', 'ward_id', 'lga_id', 'uniquewardid', 'polling_unit_number', 'polling_unit_name',
'polling_unit_description', 'lat', 'long', 'entered_by_user', 'date_entered', 'user_ip_address')

POLLING_UNIT_TABLE_ROWS = [
    ...
    None, None, None),
    (10, 5, 1, 19, 194, 'DT1401005', 'Ishere Primary School  Aghara', 'Ishere Primary School Aghara', '5.595722496',
     '5.99961724', None, None, None),
    (11, 5, 3, 34, 244, 'DT3403005', 'Igini Primary School', ' Esisi Road', '5.602005475', '6.001611141', None, None,
     None),
    (12, 1, 4, 21, 220, 'DT2104001', 'Umukwapa poll unit 1', None, '5.596383741', '5.99023883', None, None, None),
    (13, 16, 1, 22, 223, 'DT2201016', 'Church in Effurun1 Ovie', 'Church in Effurun1 Ovie', '5.59759314', '5.991187248',
     None, None, None),
    (14, 6, 1, 19, 194, 'DT1901006', 'Ishere Primary School Aghara', None, '5.90359853', '5.729595722', None, None,
     None),
    (15, 13, 1, 22, 224, 'DT2201013', 'Effurun 2 in Uvwie', 'Effurun 2 in Uvwie', '5.904090609', '5.729854354', None,
     None, None),
    (16, 5, 7, 7, 59, 'DT0607005', 'school in ethiope west', 'school in ethiope west', '5.895063582', '5.730405695',
     None, None, None),
    (17, 9, 1, 34, 242, 'DT3401009', 'agbasa 1', 'agbasa 1', '5.904748983', '5.725361522', None, None, None),
    (18, 7, 1, 22, 223, 'DT2201007', 'Customary Court P.t.i Road', 'Customary Court P.t.i Road', '5.904025184',
     '5.735836456', None, None, None),
    (19, 11, 2, 22, 224, 'DT2202011', 'effurun 2', 'effurun 2', '5.903925673', '5.736211371', None, None, None),
    (20, 1, 9, 35, 262, 'DT3501001', 'asumbo town hall1', 'asumbo town hall1', '5.879748019', '5.73172331', None, None,
     None),
    (21, 3, 2, 22, 224, 'DT2202003', 'eki-otoi', None, '5.876600455', '5.729696257', None, None, None),
    (22, 3, 7, 6, 59, 'DT0607003', 'pollling 3 in agbara', 'pollling 3 in agbara', '5.900635513', '5.72786891', None,
     None, None),
    (23, 6, 8, 6, 60, 'DT0608006', 'aghara ii', 'aghara ii', '5.879594849', '5.731894945', None, None, None),
    (24, 4, 8, 6, 60, 'Dt0608004', 'aghara ii', 'aghara ii', '5.910613554', '5.768823319', None, None, None),
    (25, 6, 9, 35, 262, 'DT3509006', 'obiteogbon quarters', 'obiteogbon quarters', '5.915854854', '5.775345359', None,
     None, None),
    (26, 7, 9, 35, 262, 'DT3509007', 'okegbe quarter1', 'okegbe quarter1', '5.916066505', '5.775475401', None, None,
     None),
    (27, 2, 7, 6, 59, 'DT0607002', 'agbasa 1', 'agbasa 1', '5.916323572', '5.775769489', None, None, None),
    (28, 13, 3, 34, 244, 'DT340313', 'gra', 'gra', '5.916405598', '5.775643861', None, None, None),
    (29, 14, 7, 6, 59, 'DT0607014', 'agbasa 1', 'agbasa 1', '5.976138434', '5.79185625', None, None, None),
    (30, 8, 4, 1, 19, 'DT0104008', 'anocha north', 'anocha north', '5.976323443', '5.791971817', None, None, None),
    (31, 12, 3, 34, 244, 'DT340312', 'gra ward', 'gra ward', '5.94474279', '5.749946582', None, None, None),
    (32, 12, 7, 6, 59, 'DT0607012', 'school in ethiope west', 'school in ethiope west', '5.960247765', '5.787697717',
     None, None, None),
    (33, 4, 3, 9, 90, 'DT0903004', 'ellu ', 'ellu ', '5.944916081', '5.749138498', None, None, None),
    (34, 11, 9, 35, 262, 'DT3509011', 'emami quarter 2', 'emami quarter 2', '5.868711331', '5.753867466', None, None,
     None),
    (35, 10, 9, 35, 262, 'DT3509010', 'emami quarter 1', 'emami quarter 1', '5.869546618', '5.752899868', None, None,
     None),
    (36, 9, 9, 35, 262, 'DT3509009', 'oguanja quarters', 'oguanja quarters', '5.869563315', '5.753218155', None, None,
     None),
    (37, 8, 9, 35, 262, 'DT3509008', 'okegbe quarters 2', 'okegbe quarters 2', '5.869457164', '5.753248025', None, None,
     None),
    (38, 5, 9, 35, 262, 'DT3509005', 'obiteogbon quarters', 'obiteogbon quarters', '5.865254514', '5.754391377', None,
     None, None),
    ...
    (40, 3, 9, 35, 262, 'DT3509003', 'ajudaibo primary school', 'ajudaibo primary school', '5.867018084', '5.750225876',
     None, None, None),
    (41, 3, 4, 9, 91, 'DT0904003', 'isoko north', 'isoko north', '5.866359036', '5.746704932', None, None, None),
    (42, 2, 9, 35, 262, 'DT3509002', 'hall 2', 'hall 2', '5.866407456', '5.746698042', None, None, None),
    (43, 4, 7, 6, 59, 'DT0607004', 'school in ethiope west', 'school in ethiope west', '5.909925383', '5.794301233',
     None, None, None),
    (44, 16, 2, 22, 224, 'DT220216', 'uvwie', 'uvwie', '5.878378164', '5.783819724', None, None, None),
    (45, 6, 7, 6, 59, 'DT0607006', 'school in ethiope west', 'school in ethiope west', '5.861365948', '5.790962175',
     None, None, None),
    (46, 14, 1, 19, 194, 'DT1901014', 'ughelli', 'ughelli', '5.861413666', '5.79088636', None, None, None),
    (47, 2, 10, 15, 156, 'DT1510002', 'cable point i', 'cable point i', '5.861461099', '5.79080631', None, None, None),
    (48, 3, 10, 15, 156, 'DT1510003', 'cable point i', 'cable point i', '5.880444551', '5.770730494', None, None, None),
    (49, 4, 10, 15, 156, 'DT1510004', 'cable point i', 'cable point i', '5.878354903', '5.783820223', None, None, None),
    (50, 5, 10, 15, 156, 'DT1510005', 'cable point i', 'cable point i', '5.878531591', '5.806744155', None, None, None),
    (51, 6, 10, 15, 156, 'DT1510006', 'cable point i', 'cable point i', '5.878639525', '5.806654972', None, None, None),
    (52, 7, 10, 15, 156, 'DT1510007', 'cable point i', 'cable point i', '5.878806006', '5.806560262', None, None, None),
    (53, 8, 10, 15, 156, 'DT1510008', 'cable point i', 'cable point i', '5.879012412', '5.806466752', None, None, None),
    (54, 9, 10, 15, 156, 'DT1510009', 'cable point i', 'cable point i', '5.867669536', '5.817836656', None, None, None),
    (
    55, 10, 10, 15, 156, 'DT1510010', 'cable point i', 'cable point i', '5.867691306', '5.818044285', None, None, None),
    (56, 11, 10, 15, 156, 'DT1510011', 'cable point i', 'cable point i', '5.867600201', '5.81823691', None, None, None),
    (57, 15, 10, 15, 156, 'DT151015', 'cable point i', 'cable point i', '5.863066776', '5.830964841', None, None, None),
    (58, 16, 10, 15, 156, 'DT151016', 'cable point i', 'cable point i', '5.873470151', '5.823753387', None, None, None),
    (59, 17, 10, 15, 156, 'DT151017', 'cable point i', 'cable point i', '5.851069593', '5.836122533', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (60, 8, 8, 22, 222, 'DT2288', 'aka avenue', 'aka avenue', '5.851158986', '5.836175239', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (61, 8, 3, 17, 176, 'DT1738', 'sapele', 'sapele', '5.851270898', '5.836155212', 'Israel', '0000-00-00 00:00:00',
     '192.168.1.109'),
    (62, 13, 7, 6, 59, 'DT6713', 'ethiope', 'ethiope', '5.85144335', '5.836146137', 'Israel', '0000-00-00 00:00:00',
     '192.168.1.109'),
    (63, 5, 4, 1, 19, 'DT145', 'Aniocha North 4', 'Aniocha North 4', '5.863091905', '5.831179239', 'christian',
     '0000-00-00 00:00:00', '192.168.1.114'),
    (64, 13, 3, 2, 6, 'DT2313', 'aniocha ward 3', 'aniocha ward 3', '5.866994163', '5.821855678', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (65, 6, 4, 1, 19, 'DT146', 'aniocha ward 4', 'aniocha ward 4', '5.867741304', '5.817980929', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (66, 21, 1, 22, 223, 'DT22121', 'uru standard junction off jakpa rd', 'uru standard junction off jakpa rd',
     '5.867601142', '5.818139328', 'Israel', '0000-00-00 00:00:00', '192.168.1.109'),
    (67, 1, 11, 15, 157, 'DT15111', 'Oshimili', 'Oshimili South', '5.807821471', '5.797203767', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (68, 2, 11, 10, 108, 'DT10112', 'Isoko', 'Isoko South', '5.807754862', '5.797288301', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (69, 3, 11, 15, 157, 'DT15113', 'Oshimili', 'Oshimili', '5.842704983', '5.786380747', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (70, 4, 11, 15, 157, 'DT15114', 'Oshimili', 'Oshimili South', '5.842790118', '5.786331657', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (71, 5, 11, 15, 157, 'DT15115', 'Oshimili', 'Oshimili South', '5.842864681', '5.78625909', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (72, 6, 11, 15, 157, 'DT15116', 'Oshimili', 'Oshimili South', '5.842019519', '5.831029509', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (73, 7, 11, 15, 157, 'DT15117', 'Oshimili', 'Oshimili South', '5.842620963', '5.831811301', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (74, 1, 5, 10, 104, 'DT105001', 'Isoko', 'Isoko South', '5.837696181', '5.812672375', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (75, 13, 10, 21, 218, 'DT211013', 'Ukwuani', 'Ukwuani ', '5.835630792', '5.824939901', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (76, 3, 4, 21, 220, 'DT2143', 'Ukwuani', 'Ukwuani', '5.835483357', '5.824884533', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (77, 6, 1, 22, 223, 'DT2216', 'Effurun', 'Effurun', '5.829120073', '5.825480729', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (78, 11, 10, 21, 218, 'DT211011', 'Ukwuani', 'Ukwuani', '5.822940228', '5.835938252', 'Christopher',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (79, 7, 4, 1, 19, 'DT147', 'aniocha', 'aniocha', '5.785890606', '5.829924057', 'Christopher', '0000-00-00 00:00:00',
     '192.168.1.109'),
    (80, 3, 0, 31, 28, 'DT3103', 'Bomadi', 'Bomadi', '5.822974806', '5.835903908', 'Dare', '0000-00-00 00:00:00',
     '192.168.1.114'),
    (81, 5, 0, 31, 28, 'DT3105', 'Bomadi', 'Bomadi', '5.813067872', '5.850975385', 'Dare', '0000-00-00 00:00:00',
     '192.168.1.114'),
    (82, 1, 0, 31, 28, 'DT310001', 'Bomadi', 'Bomadi', '5.813128721', '5.851046574', 'Dare', '0000-00-00 00:00:00',
     '192.168.1.114'),
    (83, 3, 6, 13, 135, 'DT1363', 'Udogbie Village', 'Udogbie Village', '5.795222618', '5.83904385', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (84, 8, 12, 22, 226, 'DT22128', 'aka avenue', 'aka avenue', '5.795293702', '5.839015885', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.109'),
    (85, 3, 9, 6, 61, 'DT693', 'ethiope west ', 'ethiope west ', '5.801800496', '5.895480998', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (
    86, 8, 8, 6, 60, 'DT688', 'ethiope', 'ethiope west ', '5.802012582', '5.895422869', 'Israel', '0000-00-00 00:00:00',
    '192.168.1.104'),
    (
    87, 2, 8, 6, 60, 'DT682', 'ethiope', 'ethiope west ', '5.802052137', '5.895223879', 'Israel', '0000-00-00 00:00:00',
    '192.168.1.104'),
    (88, 6, 10, 6, 62, 'DT6106', 'ethiope', 'ethiope west ', '5.800760234', '5.888332279', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (89, 12, 9, 6, 61, 'DT6912', 'ethiope unit 12', 'ethiope unit 12', '5.800857495', '5.888584717', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (90, 7, 0, 31, 26, 'DT3107', 'kolafiogbene', 'kolafio', '5.799316688', '5.892493172', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (91, 11, 0, 31, 26, 'DT31011', 'kolafiogbene', 'kolafio', '5.799247669', '5.892551277', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (92, 15, 0, 31, 26, 'DT31015', 'kolafiogbene', 'kolafiogbene', '5.949238684', '5.696328122', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (93, 16, 0, 31, 26, 'DT31016', 'kolafiogbene', 'kolafiogbene', '5.949328101', '5.696164548', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (94, 9, 0, 31, 30, 'DT3109', 'kolafiogbene', 'kolafiogbene', '5.948599325', '5.695844094', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (95, 8, 0, 31, 30, 'DT3108', 'kolafiogbene', 'kolafiogbene', '5.947600862', '5.72692069', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (96, 14, 0, 31, 26, 'DT31014', 'kolafiogbene', 'kolafiogbene', '5.9266113', '5.68939042', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (97, 18, 0, 31, 26, 'DT31018', 'kolafiogbene', 'kolafiogbene', '5.926621717', '5.689337411', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (98, 12, 0, 31, 26, 'DT31012', 'kolafiogbene', 'kolafiogbene', '5.926029293', '5.70101689', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (99, 4, 0, 31, 30, 'DT3104', 'kolafiogbene', 'kolafiogbene', '5.987535593', '5.77571573', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (100, 6, 0, 31, 30, 'DT3106', 'kolafiogbene', 'kolafiogbene', '5.964548939', '5.710539049', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (101, 10, 0, 31, 30, 'DT31010', 'kolafiogbene', 'kolafiogbene', '5.966931481', '5.714765312', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (102, 51, 0, 31, 30, 'DT31051', 'kolafiogbene', 'kolafiogbene', '5.98954208', '5.76373367', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (103, 21, 0, 31, 30, 'DT31021', 'kolafiogbene', 'kolafiogbene', '5.989685426', '5.76395642', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (104, 31, 0, 31, 30, 'DT31031', 'kolafiogbene', 'kolafiogbene', '5.970365586', '5.731097122', 'Israel',
     '0000-00-00 00:00:00', '192.168.1.104'),
    (105, 5, 5, 11, 115, 'DT1155', 'Ndokwa east', 'Ndokwa east', '5.948545677', '5.696001704', 'Dare',
     '0000-00-00 00:00:00', '192.168.1.111'),
    (106, 13, 0, 34, 244, 'DT34013', 'gra', 'gra', '5.953962649', '5.700047022', 'Israel', '0000-00-00 00:00:00',
     '192.168.1.108'),
    (107, 12, 0, 34, 244, 'DT34012', 'gra', 'gra', '5.98539512', '5.764853605', 'Israel', '0000-00-00 00:00:00',
     '192.168.1.108'),
    (108, 1, 0, 32, 38, 'DT3201', 'seimbiri', 'seimbiri', '5.989630887', '5.763867217', 'Israel', '0000-00-00 00:00:00',
     '192.168.1.108'),
    (109, 6, 5, 11, 115, 'DT1156', 'ndokwa', 'ndokwa', '5.989745019', '5.764018125', 'Israel', '0000-00-00 00:00:00',
     '192.168.1.108'),
...
STATES_TABLE_HEADER = ('state_id', 'state_name')
...
WARD_TABLE_ROWS = [
    ...
    (75, 3, 'Ihuozomor ( Ozanogogo Alisimie )', 8, 'Ihuozomor ( Ozanogogo Alisimie )', 'Bincom', '0000-00-00 00:00:00',
     '127.0.0.1'),
    ...
    (120, 9, 'Ibrede / Igbuku / Onogbokor', 11, 'Ibrede / Igbuku / Onogbokor', 'Bincom', '0000-00-00 00:00:00',
     '127.0.0.1'),
    (121, 4, 'Okpai / Utchi / Beneku', 11, 'Okpai / Utchi / Beneku', 'Bincom', '0000-00-00 00:00:00', '127.0.0.1'),
    (122, 6, 'Onyia / Adiai / Otuoku / Umuolu', 11, 'Onyia / Adiai / Otuoku / Umuolu', 'Bincom', '0000-00-00 00:00:00',
     '127.0.0.1'),
    ...
    (168, 10, 'Odorubu / Adobu / Bolou Apelebri', 16, 'Odorubu / Adobu / Bolou Apelebri', 'Bincom',
     '0000-00-00 00:00:00', '127.0.0.1'),
    ...
    (253, 0, 'Ugbuwangue / Ekurede - Itsekiri', 34, 'Ugbuwangue / Ekurede - Itsekiri', 'Bincom', '0000-00-00 00:00:00',
     '127.0.0.1'),
...
ANNOUNCED_LGA_RESULTS_TABLE_HEADER = ('result_id', 'lga_name', 'party_abbreviation', 'party_score', 'entered_by_user', 'date_entered', 'user_ip_address')
...
ANNOUNCED_PU_RESULTS_TABLE_HEADER = ('result_id', 'polling_unit_uniqueid', 'party_abbreviation', 'party_score',
...
LGA_TABLE_HEADER = ('uniqueid', 'lga_id', 'lga_name', 'state_id', 'lga_description', 'entered_by_user', 'date_entered', 'user_ip_address')
...
POLLING_UNIT_TABLE_HEADER = ('uniqueid', 'polling_unit_id', 'ward_id', 'lga_id', 'uniquewardid', 'polling_unit_number',
...
(10, 5, 1, 19, 194, 'DT1401005', 'Ishere Primary School  Aghara', 'Ishere Primary School Aghara', '5.595722496', '5.99961724', None, None, None),
(11, 5, 3, 34, 244, 'DT3403005', 'Igini Primary School', ' Esisi Road', '5.602005475', '6.001611141', None, None, None),
(12, 1, 4, 21, 220, 'DT2104001', 'Umukwapa poll unit 1', None, '5.596383741', '5.99023883', None, None, None),
(13, 16, 1, 22, 223, 'DT2201016', 'Church in Effurun1 Ovie', 'Church in Effurun1 Ovie', '5.59759314', '5.991187248', None, None, None),
(14, 6, 1, 19, 194, 'DT1901006', 'Ishere Primary School Aghara', None, '5.90359853', '5.729595722', None, None, None),
(15, 13, 1, 22, 224, 'DT2201013', 'Effurun 2 in Uvwie', 'Effurun 2 in Uvwie', '5.904090609', '5.729854354', None, None, None),
(16, 5, 7, 7, 59, 'DT0607005', 'school in ethiope west', 'school in ethiope west', '5.895063582', '5.730405695', None, None, None),
(17, 9, 1, 34, 242, 'DT3401009', 'agbasa 1', 'agbasa 1', '5.904748983', '5.725361522', None, None, None),
(18, 7, 1, 22, 223, 'DT2201007', 'Customary Court P.t.i Road', 'Customary Court P.t.i Road', '5.904025184', '5.735836456', None, None, None),
(19, 11, 2, 22, 224, 'DT2202011', 'effurun 2', 'effurun 2', '5.903925673', '5.736211371', None, None, None),
(20, 1, 9, 35, 262, 'DT3501001', 'asumbo town hall1', 'asumbo town hall1', '5.879748019', '5.73172331', None, None, None),
(21, 3, 2, 22, 224, 'DT2202003', 'eki-otoi', None, '5.876600455', '5.729696257', None, None, None),
(22, 3, 7, 6, 59, 'DT0607003', 'pollling 3 in agbara', 'pollling 3 in agbara', '5.900635513', '5.72786891', None, None, None),
(23, 6, 8, 6, 60, 'DT0608006', 'aghara ii', 'aghara ii', '5.879594849', '5.731894945', None, None, None),
(24, 4, 8, 6, 60, 'Dt0608004', 'aghara ii', 'aghara ii', '5.910613554', '5.768823319', None, None, None),
(25, 6, 9, 35, 262, 'DT3509006', 'obiteogbon quarters', 'obiteogbon quarters', '5.915854854', '5.775345359', None, None, None),
(26, 7, 9, 35, 262, 'DT3509007', 'okegbe quarter1', 'okegbe quarter1', '5.916066505', '5.775475401', None, None, None),
(27, 2, 7, 6, 59, 'DT0607002', 'agbasa 1', 'agbasa 1', '5.916323572', '5.775769489', None, None, None),
(28, 13, 3, 34, 244, 'DT340313', 'gra', 'gra', '5.916405598', '5.775643861', None, None, None),
(29, 14, 7, 6, 59, 'DT0607014', 'agbasa 1', 'agbasa 1', '5.976138434', '5.79185625', None, None, None),
(30, 8, 4, 1, 19, 'DT0104008', 'anocha north', 'anocha north', '5.976323443', '5.791971817', None, None, None),
(31, 12, 3, 34, 244, 'DT340312', 'gra ward', 'gra ward', '5.94474279', '5.749946582', None, None, None),
(32, 12, 7, 6, 59, 'DT0607012', 'school in ethiope west', 'school in ethiope west', '5.960247765', '5.787697717', None, None, None),
(33, 4, 3, 9, 90, 'DT0903004', 'ellu ', 'ellu ', '5.944916081', '5.749138498', None, None, None),
(34, 11, 9, 35, 262, 'DT3509011', 'emami quarter 2', 'emami quarter 2', '5.868711331', '5.753867466', None, None, None),
(35, 10, 9, 35, 262, 'DT3509010', 'emami quarter 1', 'emami quarter 1', '5.869546618', '5.752899868', None, None, None),
(36, 9, 9, 35, 262, 'DT3509009', 'oguanja quarters', 'oguanja quarters', '5.869563315', '5.753218155', None, None, None),
(37, 8, 9, 35, 262, 'DT3509008', 'okegbe quarters 2', 'okegbe quarters 2', '5.869457164', '5.753248025', None, None, None),
(38, 5, 9, 35, 262, 'DT3509005', 'obiteogbon quarters', 'obiteogbon quarters', '5.865254514', '5.754391377', None, None, None),
(39, 4, 9, 35, 262, 'DT3509004', 'ajudaibo primary school', 'ajudaibo primary school', '5.863768358', '5.754947902', None, None, None),
(40, 3, 9, 35, 262, 'DT3509003', 'ajudaibo primary school', 'ajudaibo primary school', '5.867018084', '5.750225876', None, None, None),
(41, 3, 4, 9, 91, 'DT0904003', 'isoko north', 'isoko north', '5.866359036', '5.746704932', None, None, None),
(42, 2, 9, 35, 262, 'DT3509002', 'hall 2', 'hall 2', '5.866407456', '5.746698042', None, None, None),
(43, 4, 7, 6, 59, 'DT0607004', 'school in ethiope west', 'school in ethiope west', '5.909925383', '5.794301233', None, None, None),
(44, 16, 2, 22, 224, 'DT220216', 'uvwie', 'uvwie', '5.878378164', '5.783819724', None, None, None),
(45, 6, 7, 6, 59, 'DT0607006', 'school in ethiope west', 'school in ethiope west', '5.861365948', '5.790962175', None, None, None),
(46, 14, 1, 19, 194, 'DT1901014', 'ughelli', 'ughelli', '5.861413666', '5.79088636', None, None, None),
(47, 2, 10, 15, 156, 'DT1510002', 'cable point i', 'cable point i', '5.861461099', '5.79080631', None, None, None),
(48, 3, 10, 15, 156, 'DT1510003', 'cable point i', 'cable point i', '5.880444551', '5.770730494', None, None, None),
(49, 4, 10, 15, 156, 'DT1510004', 'cable point i', 'cable point i', '5.878354903', '5.783820223', None, None, None),
...
WARD_TABLE_HEADER = ('uniqueid', 'ward_id', 'ward_name', 'lga_id', 'ward_description', 'entered_by_user', 'date_entered', 'user_ip_address')
